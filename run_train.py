...
if __name__ == "__main__":
    ...
    parser.add_argument('--annotation', type=str, default='', help='Additional information annotation')
    parser.add_argument('--saved_model', default='', help="path to model to continue training")
    parser.add_argument('--FT', action='store_true', help='whether to do fine-tuning')
    args = parser.parse_args()

    experiment_name = '{}-{}-{}-{}-{}_{}_{}-{}{}{}-Seed{}{}'.format(\
        args.Transformation,args.FeatureExtraction,args.SequenceModeling,args.Prediction,\
            args.select_data, args.batch_ratio, args.hidden_size, \
                   args.lr, args.scheduler,args.warmup_a, args.seed, args.annotation)
    ...
    if args.train:
        ...
        instr = 'train.py --train_data {} --valid_data {} --eval_data {} --select_data {} --batch_ratio {} --Transformation {} --FeatureExtraction {} --SequenceModeling {} --Prediction {} --manualSeed {} --lr {} --batch_size {} --imgH {} --imgW {} --num_iter {}  --milestones {} --hidden_size {} --experiment_name {} --scheduler {} --warmup_a {} --output_channel {} --valInterval {}'.format(
        ...
        if args.saved_model == '' or args.FT:
